...
class TestClientSegmentedRequestSending:
    ...
    def test_small_request_not_segmented(self, tsm, network):
    ...
    def test_large_request_segmented(self, tsm, network):
    ...
    def test_segmented_request_with_full_flow(self, network):
...
class TestClientSegmentedResponseReceiving:
    ...
    def test_segmented_complex_ack_reassembly(self, tsm, network):
    ...
    def test_client_sends_segment_acks(self, tsm, network):
...
class TestServerSegmentedRequestReceiving:
    ...
    def test_receive_segmented_request_reassembly(self, tsm, network):
...
class TestServerSegmentedResponseSending:
    ...
    def test_start_segmented_response(self, tsm, network):
    ...
    def test_segmented_response_abort_if_not_accepted(self, tsm, network):
    ...
    def test_segmented_response_full_flow(self, network):
...
class TestWindowManagement:
    ...
    def test_window_size_negotiation(self, network):
    ...
    def test_negative_ack_retransmission(self, network):
...
class TestTimeoutRecovery:
    ...
    def test_client_segment_timeout_retransmits(self, network):
    ...
    def test_client_segment_timeout_exhaustion_aborts(self, network):
    ...
    def test_server_segment_timeout_sends_negative_ack(self, network):
...
class TestDataIntegrity:
    ...
    def test_client_segments_reassembled_correctly(self, network):
    ...
    def test_server_segments_reassemble_to_original(self, network):
