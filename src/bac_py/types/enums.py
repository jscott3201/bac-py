...
class PropertyIdentifier(IntEnum):
    ...
    TIME_DELAY_NORMAL_DEPRECATED = 356  # Superseded by TIME_DELAY_NORMAL (204)
    ...
    BACNET_IPV6_UDP_PORT = 436
    BACNET_IPV6_MULTICAST_ADDRESS = 437
    IPV6_ADDRESS = 438
    IPV6_PREFIX_LENGTH = 439
    IPV6_DEFAULT_GATEWAY = 440
    IPV6_DNS_SERVER = 441
